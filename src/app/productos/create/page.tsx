...
function ProductosCreate() {
    ...
    return (<div className="min-h-screen">
        ...
        <h2 className="text-5xl font-extrabold p-5">Crear Producto</h2>

        <form onSubmit={handleSubmit} className="p-5 register-smth min-h-[100%]">
            <div>
                <h2 className="text-xl">Nombre del producto</h2>
                <input type="text" name="product_name" id=""className={available == null ? " border-2 border-slate-500 outline-none" : available ? "available" : " border-2 border-red-500 outline-none"} onChange={(e)=>searchProduct(e)} required/>
            ...
            <div>
                ...
                <input type="number" name="stock" id="" min={1} defaultValue={1} required/>
            </div>
            ...
            <div>
                ...
                <select name="category_id" id="" required>
                    ...
                    :category.map(cate=> <option key={cate.ID} id={"" + cate.ID}>{cate.category_name}</option> )}
                </select>
            </div>
            ...
            <div>
                <input type="File" id="miInputDeArchivo" className="hidden" ref={inputFile} required/>
            ...
            <div className="w-[30em] flex gap-x-4">
                <button className="flex-grow bg-blue-500 py-2 text-white rounded-lg flex items-center justify-center gap-x-2">
                    <FontAwesomeIcon icon={faSave}/>
                    CREAR</button>
                <button className="flex-grow bg-red-500 py-2 text-white rounded-lg flex items-center justify-center gap-x-2">
                    <FontAwesomeIcon icon={faCancel}/>
                    CANCELAR</button>
            </div>
